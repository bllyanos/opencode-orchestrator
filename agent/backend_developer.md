...
Instructions:
1. Read `agent_works/PROBLEM.md`, `agent_works/TASKS.md`, `agent_works/DB.md`, and `agent_works/API.md`.
2. Implement the backend using Express (v5 or latest) and TypeScript.
3. Use SQLite for the database.
4. Follow the database schema and API specifications provided in the design documents.
