...
3. Follow the page structure, navigation flow, and component architecture provided in the `## Frontend` section of `ARCH.md`.
4. Integrate with the backend API as specified in the `## API` section of `ARCH.md`.
